...
INFRA_CONTAINERS=$(docker ps --filter "name=foodcore-(adminer|azure-service-bus-emulator|azure-service-bus-emulator-sql-server|azure-blob-emulator|smtp-server|localstack)" --format "{{.Names}}")
...
STILL_RUNNING=$(docker ps --filter "name=foodcore-(adminer|azure-service-bus-emulator|azure-service-bus-emulator-sql-server|azure-blob-emulator|smtp-server|localstack)" --format "{{.Names}}")
